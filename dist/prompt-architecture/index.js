...
export class PromptComposer {
     ...
     */
    compose(dynamicContent) {
        const sorted = [...this.sections.values()].sort((a, b) => (a.priority ?? 50) - (b.priority ?? 50));
 ...
 */
export function createPromptComposer(config) {
